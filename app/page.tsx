...
export default function Home() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      {/* Giveaway Callout */}
      <section className="py-16 bg-masters-yellow">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-6">
              <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0">
                <svg className="w-10 h-10 text-masters-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
                </svg>
              </div>
              <div>
                <h3 className="text-2xl md:text-3xl font-bold text-masters-green-dark mb-1">
                  Share Your Trip, Win $3K
                </h3>
                <p className="text-masters-green-dark/70">
                  Tell us about your golf trip and you&apos;re entered to win a $3,000 trip!
                </p>
              </div>
            </div>
            <Link
              href="/share-trip"
              className="group bg-masters-green hover:bg-masters-green-dark text-white px-8 py-4 rounded-xl font-bold text-lg transition-all hover:-translate-y-1 shadow-lg flex items-center gap-2 whitespace-nowrap"
            >
              Share Your Trip
