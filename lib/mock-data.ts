...
export const mockCourses = [
  ...
  },
  {
    ...
    description: 'Premier public course in Plymouth featuring championship conditions, GPS-equipped carts, and range balls included with every round. Known for excellent course conditions and challenging layout.',
    address: '444 Long Pond Road',
    city: 'Plymouth',
    state: 'MA',
    zipCode: '02360',
    phone: '(508) 224-6016',
    email: 'info@waverlyoaksgc.com',
    website: 'https://www.waverlyoaksgc.com',
    bookingUrl: 'https://www.waverlyoaksgc.com/golf/rates/',
    holes: 18,
    par: 72,
    yardage: 7014,
    greenFee: 110, // Prime season weekday rate (representative)
    cartFee: 0, // Cart included in all rates
    cartIncluded: true,
    openTime: '06:30',
    closeTime: '19:00',
    teeTimeInterval: 10,
    maxPlayersPerGroup: 4,
    amenities: JSON.stringify(['Pro Shop', 'Restaurant', 'Driving Range', 'Practice Green', 'GPS Carts', 'Range Balls Included']),
    imageUrl: 'https://images.unsplash.com/photo-1587174486073-ae5e5cff23aa?w=800',
    rating: 4.7,
    region: 'South Shore',
    seasonalRates: JSON.stringify({
      earlySeason: {
        period: 'March-April',
        weekday: 90,
        weekend: 100,
    ...
    policies: JSON.stringify({
      ...
      twilightNote: 'Twilight rounds may not complete 18 holes',
      inclusions: ['Cart with GPS', 'Range balls'],
    }),
    verified: true,
